...
class SiameseFaceNet(object):
    ...
    def create_vgg16_model(self):
        path =os.getcwd()
        WEIGHTS_PATH = path + '\\models_1\\weights\\vgg16_weights_tf_dim_ordering_tf_kernels.h5'
        #vgg16_model = VGG16(include_top=self.vgg16_include_top, weights='imagenet')
        vgg16_model = VGG16(include_top=self.vgg16_include_top, weights=WEIGHTS_PATH)
