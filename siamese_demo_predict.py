    ...
    def show_video_images(self):
        ...
        if self.playCapture.isOpened():
            ...
            if success:
                ...
                thread1 =rectangleThread(self.threadId ,frame,self.Pnet,self.Rnet,self.Onet,lock,self.imgeLabel_0,self.imgeLabel_1,self.imgeLabel_2)
    ...
    def fileName(self):
        ...
        for i in range(0, len(list)):
            ...
            for i in range(0, len(listname)):
                ...
                database[listname[i].split('.')[0]] = [fnet.img_to_encoding(path+'/'+listname[i])]
            #print (path+'/'+listname[i])
        return database
...
if __name__ == "__main__":
    ...
    # mw.show()
    predict =PredictImg()
    database =predict.fileName()
    predict.predict(database)
    #sys.exit(mapp.exec_())